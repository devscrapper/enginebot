...
module Planning
  ...
  class Objective
    ...
    EVALUATING_LANDING_PAGE_KEYWORD_MIN = 30 * IceCube::ONE_MINUTE #min de démarrage est 30mn du matin
    ...
    def to_event
      ...
      periodicity = IceCube::Schedule.new(@date_objective + CHOOSING_LANDING_PAGES_DAY,
